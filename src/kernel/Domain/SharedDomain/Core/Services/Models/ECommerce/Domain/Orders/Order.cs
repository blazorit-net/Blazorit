...
using Blazorit.Domain.SharedDomain.Core.Services.Models.ECommerce.Domain.Payments;

namespace Blazorit.Domain.SharedDomain.Core.Services.Models.ECommerce.Domain.Orders
{
    public class Order
    {
