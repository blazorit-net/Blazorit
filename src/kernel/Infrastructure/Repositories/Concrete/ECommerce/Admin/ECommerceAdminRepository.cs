...
using Blazorit.UseCases.Infrastructure.Repositories.Abstract.ECommerce.Admin;
...
namespace Blazorit.Infrastructure.Repositories.Concrete.ECommerce.Admin
{
    ...
    {
        private readonly IDbContextFactory<DomDbContext> _contextFactory;
        ...
        public ECommerceAdminRepository(IDbContextFactory<DomDbContext> contextFactory, ILogger<ECommerceAdminRepository> logger)
        {
            _contextFactory = contextFactory;
            _logger = logger;
        }
