...
public partial class DomDbContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder
            ...
            .ApplyConfiguration(new DlyDeliveryConfiguration())
            .ApplyConfiguration(new DlyDeliveryMethodConfiguration())
            .ApplyConfiguration(new DlyMethodsAddressConfiguration())
            .ApplyConfiguration(new DlyUserDeliveryConfiguration())
            .ApplyConfiguration(new OrdCheckoutOrderConfiguration())
            .ApplyConfiguration(new OrdOrderConfiguration())
            .ApplyConfiguration(new OrdOrderListConfiguration())
            .ApplyConfiguration(new PmntPaymentConfiguration())
            .ApplyConfiguration(new PmntPaymentMethodConfiguration())
            .ApplyConfiguration(new ProdCategoryConfiguration())
            .ApplyConfiguration(new ProdPictureConfiguration())
            .ApplyConfiguration(new ProdProductConfiguration())
            .ApplyConfiguration(new WishWishConfiguration())
            .ApplyConfiguration(new WishWishListConfiguration())
            
            // Views
            .ApplyConfiguration(new VwCartShopcartConfiguration())
            .ApplyConfiguration(new VwDlyDeliveryConfiguration())
            .ApplyConfiguration(new VwDlyMethodsAddressConfiguration())
            .ApplyConfiguration(new VwDlyUserDeliveryConfiguration())
            .ApplyConfiguration(new VwOrdOrderConfiguration())
            .ApplyConfiguration(new VwProdProductConfiguration());
